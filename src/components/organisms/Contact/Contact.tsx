...
const Contact = () => {
    ...
    return (
        <section
            id="contact"
            className="contact shadow-premium fade-in-section"
        >
            <div className="contact-container">
                ...
                <p className="contact-description">
                    Vamos transformar sua ideia em produto? Ou você já tem um
                    projeto e precisa atualizá-lo? Estou pronto para colaborar
                    no desenvolvimento de soluções eficientes. Entre em contato
                    e vamos conversar!
                </p>
